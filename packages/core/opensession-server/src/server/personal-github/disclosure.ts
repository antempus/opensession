...
export const PERSONAL_CONNECTION_DISCLOSURE = Object.freeze({
  ...
  text: "Your connection is personal, but the server is shared. Server operators and agents running under Open Session's system account or with administrator (root) access can read your GitHub credentials, repository files, and session data. Only connect repositories you trust this server with.",
});
